			...
			<table>
				<tr>
					...
					<th colspan="3" style="border: none;">
						<a href="data-member-tambah.php"><button class="tombolbiru"><i class="fa fa-plus"></i>Tambah Member</button></a>
					</th>
				</tr>
				<tr>
					<td></td>
					...
					<td style="border: none;">
						<a href="data-member-detail.php"><button class="tombolbiru">Detail</button></a>
					</td>
					<td style="border: none;">
						<a href="data-member-edit.php"><button class="tombolbiru">Edit</button></a>
					</td>
					<td style="border: none;">
